                     ...
                     {lastStop && lastStop !== destination && (
                        <div className="flex-1 bg-white p-2 rounded-2xl border border-slate-200 shadow-sm flex flex-col md:flex-row gap-2">
                           <button
                              ...
                              className={`flex-1 flex items-center gap-3 p-3 rounded-xl transition-all border-2 text-left ${strategy === 'OPEN_JAW'
                           ...
                           <button
                              ...
                              className={`flex-1 flex items-center gap-3 p-3 rounded-xl transition-all border-2 text-left ${strategy === 'ROUND_TRIP'
